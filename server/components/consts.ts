export const ADMIN_TOKEN_EXPIRED = 60 * 60 * 24 * 30; // sec
export const ADMIN_ACCESS_TOKEN = "adminaccesstoken";
export const TOKEN_EXPIRED = 60 * 60 * 24 * 30; // sec
...
export const MEDIA_PAGING_LIMIT = 30;

export const DOCUMENTS_PAGING_LIMIT = 10;
...
export const QUEUE_SMS = "2024QA_QUEUE_SMS";
export const QUEUE_CREATE_CONTACT = "2024QA_QUEUE_CREATE_CONTACT";
export const QUEUE_PUSH = "2024QA_QUEUE_PUSH";
export const QUEUE_SSE = "2024QA_QUEUE_SSE";
export const QUEUE_MESSAGES_SSE = "2024QA_QUEUE_MESSAGES_SSE";
export const QUEUE_MESSAGE_RECORDS_SSE = "2024QA_QUEUE_MESSAGE_RECORDS_SSE";
export const QUEUE_WEBHOOK = "2024QA_QUEUE_WEBHOOK";

export const MESSAGE_ACTION_NEW_MESSAGE = "NEW_MESSAGE";
export const PUSH_TYPE_NEW_MESSAGE = "NEW_MESSAGE";
export const PUSH_TYPE_DELETE_MESSAGE = "DELETE_MESSAGE";
export const PUSH_TYPE_UPDATE_MESSAGE = "UPDATE_MESSAGE";
export const PUSH_TYPE_NEW_MESSAGE_RECORD = "NEW_MESSAGE_RECORD";
export const PUSH_TYPE_DELETED_MESSAGE_RECORD = "DELETE_MESSAGE_RECORD";
...
export const PUSH_TYPE_REMOVED_FROM_ROOM = "REMOVED_FROM_ROOM";
...
export const SYSTEM_MESSAGE_TYPE_USER_LEAVE_GROUP = "user_left_group";
export const SYSTEM_MESSAGE_TYPE_UPDATE_GROUP_NAME = "updated_group_name";
export const SYSTEM_MESSAGE_TYPE_UPDATE_GROUP_AVATAR = "updated_group_avatar";
export const SYSTEM_MESSAGE_TYPE_ADD_GROUP_MEMBERS = "added_group_members";
export const SYSTEM_MESSAGE_TYPE_REMOVE_GROUP_MEMBERS = "removed_group_members";
export const SYSTEM_MESSAGE_TYPE_ADD_GROUP_ADMINS = "added_group_admins";
export const SYSTEM_MESSAGE_TYPE_REMOVE_GROUP_ADMINS = "removed_group_admins";
