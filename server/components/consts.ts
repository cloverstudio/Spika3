...
export const SYSTEM_MESSAGE_TYPE_UPDATE_GROUP = "updated_group";
...
export const SYSTEM_MESSAGE_TYPE_UPDATE_GROUP_ADMINS = "updated_group_admins";
export const SYSTEM_MESSAGE_TYPE_UPDATE_GROUP_MEMBERS = "updated_group_members";
