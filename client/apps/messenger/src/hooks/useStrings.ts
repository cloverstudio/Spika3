...
const en = {
    ...
    acceptTermsInstructions: 'Click on "Accept & Continue" to accept the ',
    ...
    maxAge: "Max age",
    filters: "Filters",
    noContacts: "No contacts found with that term",
    noRooms: "No chats found with that term",
    reset: "Reset",
    welcome: "Welcome!",
    back: "back",
    ...
    deleteUserQuestion: "Delete user account?",
    deleteUserDescription: "All user data will be deleted. This action cannot be undone.",
