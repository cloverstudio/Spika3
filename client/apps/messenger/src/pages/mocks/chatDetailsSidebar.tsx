...
import { Avatar, Box, Stack, Paper, Container,Grid, Button, Link, Divider,IconButton } from "@mui/material";
        ...
        <ThemeProvider theme={theme}>
            <Box className='top-details-box'>
                <Box className='inner-box'>
                    <Avatar className='chat-avata' alt="Remy Sharp" src= "../../../../../../documents/pages/login_robot_image.svg"  />
                    ...
                    <Box >
                        ...
                        <Box >
                            <label className='side-empty-title'>You haven’t favorited any message so far....</label>
                        </Box>
                    </Box>
                    <Box >
                        <Box >
                        ...
                        <Box >
                            <label className='side-empty-title'>There is no media shared so far...</label>
                        </Box>
                    </Box>
                </Box>
            </Box>
