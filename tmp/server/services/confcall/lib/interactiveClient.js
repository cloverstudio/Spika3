...
module.exports = function () {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            socket.on('connect', function () { return process.stdin.setRawMode(true); });
            socket.on('close', function () { return process.exit(0); });
            socket.on('exit', function () { return socket.end(); });
            return [2 /*return*/];
        });
    });
};
