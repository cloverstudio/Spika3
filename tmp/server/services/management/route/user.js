...
exports.default = (function (params) {
    ...
    router.post("/", adminAuth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var userReq, displayName, emailAddress, telephoneNumber, avatarUrl, verified, user, email, newUser, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (utils_1.default.isEmpty(displayName))
                        return [2 /*return*/, res
                                .status(400)
                                .send((0, response_1.errorResponse)("Display name is required", userReq.lang))];
                ...
                case 3:
                    ...
                    if (user.length > 0 && email != null) {
                        return [2 /*return*/, res
                                .status(400)
                                .send((0, response_1.errorResponse)("Phone number and email are already in use", userReq.lang))];
                    }
                    else if (user.length > 0) {
                        return [2 /*return*/, res
                                .status(400)
                                .send((0, response_1.errorResponse)("Phone number is already in use", userReq.lang))];
                    }
                    else if (email != null) {
                        return [2 /*return*/, res.status(400).send((0, response_1.errorResponse)("Email is already in use", userReq.lang))];
                    }
                ...
                case 4:
                    newUser = _a.sent();
                    return [2 /*return*/, res.send((0, response_1.successResponse)({ user: newUser }, userReq.lang))];
                case 5:
                    e_1 = _a.sent();
    ...
    router.get("/", adminAuth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var page, userReq, users, count, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    router.get("/:userId", adminAuth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var userReq, userId, user, e_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userReq = req;
                ...
                case 2:
                    user = _a.sent();
                    if (!user)
                        return [2 /*return*/, res.status(404).send((0, response_1.errorResponse)("Wrong user id", userReq.lang))];
                    return [2 /*return*/, res.send((0, response_1.successResponse)({ user: user }, userReq.lang))];
                case 3:
                    e_3 = _a.sent();
    ...
    router.put("/:userId", adminAuth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var userReq, userId, displayName, emailAddress, telephoneNumber, avatarUrl, verified, verificationCode, user, phoneNumber, email, updateValues, updateUser, e_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userReq = req;
                ...
                case 4:
                    ...
                    if (telephoneNumber)
                        updateValues.telephoneNumber = telephoneNumber;
                    if (avatarUrl)
                        updateValues.avatarUrl = avatarUrl;
                    if (verified != null)
                        updateValues.verified = verified;
                    if (verificationCode)
                        updateValues.verificationCode = verificationCode;
                ...
                case 5:
                    updateUser = _a.sent();
                    return [2 /*return*/, res.send((0, response_1.successResponse)({ user: updateUser }, userReq.lang))];
                case 6:
                    e_4 = _a.sent();
    ...
    router.delete("/:userId", adminAuth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var userReq, userId, user, deleteResult, e_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userReq = req;
