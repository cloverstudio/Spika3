...
describe("Admin room management API", function () {
    describe("/api/management/room POST", function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, supertest_1.default)(server_1.default)
                            ...
                            type: faker_1.default.lorem.word(),
                            avatarUrl: "",
                            deleted: false,
                        })
                    ...
                    case 1:
                        response = _a.sent();
                        global_1.default.createdRoom = response.body.data.room;
        ...
        it("wrong room name", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, supertest_1.default)(server_1.default)
    ...
    describe("/api/management/room/:roomId PUT", function () {
        it("Should work", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, supertest_1.default)(server_1.default)
                            .put("/api/management/room/" + global_1.default.createdRoom.id)
                            .send({
                            name: faker_1.default.lorem.word(),
                            type: faker_1.default.lorem.word(),
                            avatarUrl: "",
    ...
    describe("/api/management/room/:roomId GET", function () {
        it("Should work", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, supertest_1.default)(server_1.default)
                            .get("/api/management/room/" + global_1.default.createdRoom.id)
                            .set({ "admin-accesstoken": global_1.default.adminToken })];
                    case 1:
                        response = _a.sent();
                        (0, chai_1.expect)(response.status).to.eqls(200);
    ...
    describe("/api/management/room GET", function () {
        it("Should work", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    describe("/api/management/room?page GET", function () {
        it("Should work", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    describe("/api/management/room/:roomId DELETE", function () {
        it("Should work", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, supertest_1.default)(server_1.default)
                            .delete("/api/management/room/" + global_1.default.createdRoom.id)
                            .set({ "admin-accesstoken": global_1.default.adminToken })];
                    case 1:
                        response = _a.sent();
                        (0, chai_1.expect)(response.status).to.eqls(200);
...
//# sourceMappingURL=09_management_room.js.map