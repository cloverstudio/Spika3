...
function default_1() {
    var _this = this;
    var count = (0, react_redux_1.useSelector)(function (state) {
        ...
        return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, get("/management/auth/check")];
                    case 1:
                        response = _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (loginResult.token) {
                            ...
                            dispatch(
                                (0, adminAuthSlice_1.login)({
                                    token: loginResult.token,
                                    username: username,
                                    expireDate: dayjs_1.default
                                        .unix(loginResult.expireDate)
                                        .toDate(),
                                })
                            );
