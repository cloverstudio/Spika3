        ...
        react_1.default.createElement(material_1.Box, null,
            ...
            react_1.default.createElement(AppBar, { position: "absolute", open: open },
                react_1.default.createElement(material_1.Toolbar, { sx: {
                    ...
                    react_1.default.createElement(material_1.Typography, { component: "h1", variant: "h6", color: "inherit", noWrap: true, sx: { flexGrow: 1 } }, "Dashboard | Spika v3"),
            ...
            react_1.default.createElement(material_1.Drawer, { variant: "permanent", open: open },
                ...
                react_1.default.createElement(material_1.Divider, null),
                react_1.default.createElement(material_1.List, null,
                    react_1.default.createElement(material_1.ListItem, { button: true },
                    ...
                    react_1.default.createElement(material_1.ListItem, { button: true },
                        react_1.default.createElement(material_1.ListItemIcon, null,
                            react_1.default.createElement(icons_material_1.ShoppingCart, null)),
                        react_1.default.createElement(material_1.ListItemText, { primary: "Orders" })),
                    react_1.default.createElement(material_1.ListItem, { button: true },
                        react_1.default.createElement(material_1.ListItemIcon, null,
                            react_1.default.createElement(icons_material_1.People, null)),
                        react_1.default.createElement(material_1.ListItemText, { primary: "Customers" })),
                    react_1.default.createElement(material_1.ListItem, { button: true },
                        react_1.default.createElement(material_1.ListItemIcon, null,
                            react_1.default.createElement(icons_material_1.BarChart, null)),
                        react_1.default.createElement(material_1.ListItemText, { primary: "Reports" })),
                    react_1.default.createElement(material_1.ListItem, { button: true },
                        react_1.default.createElement(material_1.ListItemIcon, null,
                            react_1.default.createElement(icons_material_1.Layers, null)),
                        react_1.default.createElement(material_1.ListItemText, { primary: "Integrations" })))),
            react_1.default.createElement(material_1.Box, { component: "main", sx: {
                ...
                react_1.default.createElement(material_1.Toolbar, null),
                react_1.default.createElement(material_1.Container, { maxWidth: "lg", sx: { mt: 4, mb: 4 } }, "content")))));
}
