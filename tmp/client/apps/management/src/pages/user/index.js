        ...
        return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, get("/management/user?page=" + page)];
                    case 2:
                        response = _a.sent();
                        data = response.data;
                        setList(data.list);
            ...
            renderCell: function (params) {
                return react_1.default.createElement(
                    ...
                    params.value
                        ...
                        : react_1.default.createElement(icons_material_1.CancelOutlined, {
                              style: { fill: "red" },
                          })
                );
            },
            ...
            getActions: function (params) {
                return [
                    react_1.default.createElement(x_data_grid_1.GridActionsCellItem, {
                        ...
                        label: "Detail",
                        onClick: function () {
                            return history.push("/user/detail/" + params.id);
                        },
                        showInMenu: true,
                    }),
                    react_1.default.createElement(x_data_grid_1.GridActionsCellItem, {
                        icon: react_1.default.createElement(icons_material_1.DevicesOther, null),
                        label: "Devices",
                        onClick: function () {
                            return history.push("/user/" + params.id + "/devices");
                        },
                        showInMenu: true,
                    }),
                    react_1.default.createElement(x_data_grid_1.GridActionsCellItem, {
                        icon: react_1.default.createElement(icons_material_1.MeetingRoom, null),
                        label: "Rooms",
                        onClick: function () {
                            return history.push("/user/" + params.id + "/room");
                        },
                        showInMenu: true,
                    }),
                    react_1.default.createElement(x_data_grid_1.GridActionsCellItem, {
                        ...
                        label: "Edit",
                        onClick: function () {
                            return history.push("/user/edit/" + params.id);
                        },
                        showInMenu: true,
                    }),
                    react_1.default.createElement(x_data_grid_1.GridActionsCellItem, {
                        ...
                        label: "Delete",
                        onClick: function () {
                            return history.push("/user/delete/" + params.id);
                        },
                        showInMenu: true,
                    }),
                ];
