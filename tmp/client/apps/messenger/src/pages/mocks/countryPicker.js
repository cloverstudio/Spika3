...
var defaults = __importStar(require("./countries"));
...
var CountryPicker = function (props) {
    var countries = defaults.countries;
    var classes = useStyles();
    var _a = react_1.default.useState(""), searchText = _a[0], setSearchText = _a[1];
    var _b = react_1.default.useState(countries), tempCountries = _b[0], setTempCountries = _b[1];
    ...
    var filterCountries = function (search) { return __awaiter(void 0, void 0, void 0, function () {
        var filter;
        return __generator(this, function (_a) {
            filter = countries.filter(function (country) {
