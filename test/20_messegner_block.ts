import { Room, User, Block } from "@prisma/client";
...
describe("API", () => {
    ...
    describe("/api/messenger/blocks POST", () => {
        ...
        it("Block is stored in db", async () => {
            ...
            const block = await globals.prisma.block.findUnique({
    ...
    describe("/api/messenger/blocks/:id DELETE", () => {
        ...
        before(async () => {
            ...
            block = await globals.prisma.block.create({
    ...
    describe("/api/messenger/blocks/userId/:userId DELETE", () => {
        ...
        before(async () => {
            user = await createFakeUser();
            await globals.prisma.block.create({
                data: { userId: globals.userId, blockedId: user.id },
            });
        });
